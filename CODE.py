...
plt.title('Percentage with Any Energy Insecurity by Census Division (2020)')
plt.xlabel('Census Division')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/any_insecurity_by_division_sorted.png')
...
plt.title('Percentage Receiving Disconnect Notices by Census Division (2020)')
plt.xlabel('Census Division')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/disconnect_notices_by_division_sorted.png')
...
plt.title('Percentage with Any Energy Insecurity by Income Level (2020)')
plt.xlabel('Income Level')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/any_insecurity_by_income.png')
...
plt.title('Percentage Receiving Disconnect Notices by Income Level (2020)')
plt.xlabel('Income Level')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/disconnect_notices_by_income.png')
...
plt.title('Percentage with Any Energy Insecurity by Race (2020)')
plt.xlabel('Race')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/any_insecurity_by_race_sorted.png')
...
plt.title('Percentage Receiving Disconnect Notices by Race (2020)')
plt.xlabel('Race')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/disconnect_notices_by_race_sorted.png')
...
plt.title('Percentage with Any Energy Insecurity by Construction Year (2020)')
plt.xlabel('Construction Year')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/any_insecurity_by_construction_year.png')
...
plt.title('Percentage Receiving Disconnect Notices by Construction Year (2020)')
plt.xlabel('Construction Year')
plt.ylabel('Percentage (%)')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
plt.savefig('figures/disconnect_notices_by_construction_year.png')